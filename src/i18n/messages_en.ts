...
export const EN = {
  ...
  'notify.notTextFile': "Not a text file, so it is not opened in the editor. Download it and open it with an app on your device.",
  ...
  'explorer.upload.starting': { one: "Starting upload: {count} file from \"{source}\"", other: "Starting upload: {count} files from \"{source}\"" },
  'explorer.upload.importFailedFor': "Import failed for {name}: {reason}",
  'explorer.upload.completeUploaded': { one: "Upload complete: {count} item uploaded.", other: "Upload complete: {count} items uploaded." },
  ...
  'explorer.download.partial': { one: "Download complete, but {count} file failed to read.", other: "Download complete, but {count} files failed to read." },
  ...
  'explorer.delete.message': { one: "Are you sure you want to delete {count} item?", other: "Are you sure you want to delete {count} items?" },
  ...
  'systemModal.reset.message': "WARNING: This will permanently delete ALL files and settings.\n\nAre you absolutely sure you want to proceed?",
  ...
  'systemModal.persistenceDenied': "Storage persistence: not granted — the browser may evict this site's data under storage pressure. Export a backup regularly.",
  'systemModal.persistenceUnknown': "Storage persistence: unknown.",
  'systemModal.backup.creating': "Creating Backup...",
  'systemModal.backup.skippedNote': { one: " Skipped {count} provider-managed file (see {manifest}).", other: " Skipped {count} provider-managed files (see {manifest})." },
  'systemModal.backup.exportedWithErrors': { one: "Backup Exported, but {count} file failed to read.{note}", other: "Backup Exported, but {count} files failed to read.{note}" },
  ...
  'systemModal.restore.message': "CAUTION: This will ERASE all current files and restore from \"{name}\".\n\nAre you sure you want to continue?",
  'systemModal.restore.confirm': "Restore",
  'systemModal.restore.progress': "Restoring Backup...",
  'systemModal.restore.complete': { one: "Restore Complete: {count} file. Reloading...", other: "Restore Complete: {count} files. Reloading..." },
  ...
  'systemModal.index.restoreMessage': "CAUTION: This will overwrite your entire file system index with \"{name}\".\nAre you sure you want to proceed?",
